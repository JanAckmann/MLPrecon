...
def main(activation = 'relu',learning_rate=10.0**(-5),hidden_layers=5,width=200,Lat=9):
    ...
    callbacks=[EarlyStopping(monitor='val_loss', patience=100), \
                ModelCheckpoint(filepath='ModelWeights/model2x2_1x0_l'+str(hidden_layers)+'w'+str(width)+'_METRICnorm_Lat_Lcoeff_R_uselinear_noinputact'+str(Lat)+'_ext_DP.h5', \
    ...
    f = open('model2x2_1x0_l'+str(hidden_layers)+'w'+str(width)+'_METRICnorm_Lcoeff_R_uselinear_Lats_ext_DP_noinputact.txt', "a")
